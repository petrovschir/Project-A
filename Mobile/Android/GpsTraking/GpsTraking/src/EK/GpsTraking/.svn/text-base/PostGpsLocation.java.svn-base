...
public class PostGpsLocation extends PostData<GpsLocation>
{
	public PostGpsLocation(Context uiContext, String locationServiceUrl)
	{
		super(uiContext, locationServiceUrl);
	}

	@Override
	protected HttpResponse postData(GpsLocation data) throws ClientProtocolException, IOException {
